...
{
    const string privateCode = "zDsyPhyPgEKYxMR27yDHAwMOz1-H4CWkOuZ8at7XD0gQ";  //Key to Upload New Info
    const string publicCode = "63a31b868f40bb1070d278f9";   //Key to download
